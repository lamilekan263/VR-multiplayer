...
public class LocalXRRig : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    void Update()
    {
        ...
        {
            HandController[] leftHandControllerComponent =
            leftHandTransform.GetComponentsInChildren<HandController>();
        ...
        {
            HandController[] rightHandControllerComponent =
            rightHandTransform.GetComponentsInChildren<HandController>();
    ...
    public void OnInput(NetworkRunner runner, NetworkInput input)
    {
        ...
        if (leftHandController && rightHandController)
        {
            ...
            rigInput.leftTriggerValue =
    leftHandController.GetTriggerValue();
            rigInput.rightTriggerValue =
            rightHandController.GetTriggerValue();
        }
        input.Set(rigInput);
    }
    #endregion
    ...
    { }
    public void OnInputMissing(NetworkRunner runner, PlayerRef
    player, NetworkInput input)
    { }
    ...
    PlayerRef player, ArraySegment<byte> data)
    { }
    public void OnSceneLoadDone(NetworkRunner runner) { }
    public void OnSceneLoadStart(NetworkRunner runner) { }
    public void OnObjectEnterAOI(NetworkRunner runner, NetworkObject
    obj, PlayerRef player)
    { }
    public void OnObjectExitAOI(NetworkRunner runner, NetworkObject
    obj, PlayerRef player)
    { }
    public void OnReliableDataReceived(NetworkRunner runner,
    PlayerRef player, ReliableKey key, ArraySegment<byte> data)
    { }
    public void OnReliableDataProgress(NetworkRunner runner,
    PlayerRef player, ReliableKey key, float progress)
    { }
    #endregion
}
